...
set(GOOGLETEST_PATH
    ...
    CACHE PATH "") # Mind the quotes
execute_process(
    COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}" -DALLOW_DOWNLOADING_GOOGLETEST=${BENCHMARK_DOWNLOAD_DEPENDENCIES}
            -DGOOGLETEST_PATH:PATH=${GOOGLETEST_PATH} .
...
set_target_properties(gmock_main PROPERTIES INTERFACE_SYSTEM_INCLUDE_DIRECTORIES

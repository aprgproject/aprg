...
macro(add_filecheck_test name)
    ...
    add_custom_target(
        copy_${name} ALL
        COMMAND ${PROJECT_SOURCE_DIR}/tools/strip_asm.py $<TARGET_OBJECTS:${name}> ${ASM_OUTPUT_FILE}
    ...
    foreach(prefix ${ARG_CHECK_PREFIXES})
        add_test(
            NAME run_${name}_${prefix}
            COMMAND ${LLVM_FILECHECK_EXE} ${name}.cc --input-file=${ASM_OUTPUT_FILE}

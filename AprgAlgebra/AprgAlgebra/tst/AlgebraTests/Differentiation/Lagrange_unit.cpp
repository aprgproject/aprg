...
TEST(LagrangeTest, GetLagrangeMultipliersWorks) {
    ...
    Term const lagrangeFunction(Polynomial{Monomial(1, {{"x", 1}, {"y", 1}, {"z", 1}}), Monomial(-1, {{"V", 1}})});
...
TEST(LagrangeTest, GetLagrangeMultipliersWorksUsingExample1) {
    ...
    Term const termToTest(Polynomial{Monomial(1, {{"x", 1}, {"z", 1}}), Monomial(1, {{"y", 1}, {"z", 1}})});
    Term const lagrangeFunction1(Polynomial{Monomial(1, {{"x", 2}}), Monomial(1, {{"y", 2}}), Monomial(-2, {})});
    Term const lagrangeFunction2(Polynomial{Monomial(1, {{"y", 1}, {"z", 1}}), Monomial(-2, {})});
    ...
    string const stringToExpect1("(((1/32)[z^6] + (-1/16)[z^4])^(1/2))");
    string const stringToExpect2("{EmptyTerm}");

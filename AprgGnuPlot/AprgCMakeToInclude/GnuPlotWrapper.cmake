...
set(GNU_PLOT_WRAPPER_TEST_INCLUDE_DIRECTORIES ${GNU_PLOT_WRAPPER_TEST_DIRECTORY})
...
print_status(
  "Looking for tests C/C++ files in: [${GNU_PLOT_WRAPPER_TEST_DIRECTORY}]")
...
add_library(GNU_PLOT_WRAPPER ${GNU_PLOT_WRAPPER_SOURCES} ${GNU_PLOT_WRAPPER_TESTS})

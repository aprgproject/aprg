...
public:
    constexpr AlbaYearMonthDay() = default;
...
public:
    constexpr AlbaHourMinuteSecond() = default;
...
public:
    ...
    constexpr AlbaDateTime() = default;
    ...
    constexpr AlbaDateTime(
        ...
        : m_yearMonthDay(yearMonthDay), m_hourMinuteSecond(hourMinuteSecond), m_microseconds(microseconds) {}
...
private:
    ...
    int32_t m_sign{1};  // sign is the hottest parameter (based from my evaluation)

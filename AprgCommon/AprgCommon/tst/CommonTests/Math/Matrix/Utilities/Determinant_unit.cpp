...
TEST(DeterminantTest, GetIndexWithHighestNumberOfZerosWorks) {
    ListOfAlbaMatrixData<int> const rowsAndColumns{{1, 2, 3}, {0, 5, 0}, {7, 0, 9}};
...
TEST(DeterminantTest, GetDeterminantWorks) {
    AlbaMatrix<int> const matrix1(1, 1, 5);
    AlbaMatrix<int> const matrix2(2, 2, {2, -1, 3, 2});
    AlbaMatrix<int> const matrix3(3, 3, {1, 2, 3, 2, 1, 3, 3, 1, 2});
    AlbaMatrix<int> const matrix4(4, 4, {1, 2, -3, 4, -4, 2, 1, 3, 3, 0, 0, -3, 2, 0, -2, 3});
    AlbaMatrix<int> const matrix5(4, 4, {4, 3, 2, 2, 0, 1, -3, 3, 0, -1, 3, 3, 0, 3, 1, 1});
    AlbaMatrix<int> const matrix6(4, 4, {1, 2, 3, 4, 2, 5, 7, 3, 4, 10, 14, 6, 3, 4, 2, 7});
...
TEST(DeterminantTest, GetValueUsingCramerRuleWorks) {
    AlbaMatrix<int> const matrix(3, 3, {3, 0, -1, -3, 1, 1, -5, 0, 2});
    AlbaMatrix<int>::MatrixData const newColumn{3, 2, 4};
...
TEST(DeterminantTest, GetValueFromCoFactorExpansionWorks) {
    AlbaMatrix<int> const matrix(4, 4, {1, 2, -3, 4, -4, 2, 1, 3, 3, 0, 0, -3, 2, 0, -2, 3});
...
TEST(AlbaMatrixUtilitiesTest, GetMatrixWithOneColumnAndOneRowRemovedWorks) {
    ...
    AlbaMatrix<int> const resultMatrix(getMatrixWithOneColumnAndOneRowRemoved(matrix, 1, 2));

    AlbaMatrix<int> const expectedMatrix(2, 2, {1, 3, 4, 6});

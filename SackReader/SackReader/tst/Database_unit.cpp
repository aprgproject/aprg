...
TEST(DatabaseTest, SaveAndLoadFile)
{
    ...
    databaseToBeSaved.messageNameToStructureNameMap["MessageName"] = "StructureName";
    ...
    EXPECT_EQ("StructureName", loadedDatabase.messageNameToStructureNameMap.at("MessageName"));

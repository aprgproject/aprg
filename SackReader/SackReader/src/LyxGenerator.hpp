...
private:
    ...
    void saveTypedefDefinitionSubsubsection(std::string const& typedefName, std::ofstream & typedefDefinitionsStream);
    ...
    void saveTypedefTable(std::string const& typedefName, std::ofstream & typedefTableStream);
    ...
    void generateTypedefForDisplayTablesIfNeeded(std::string const& typedefName, DisplayTable & displayTable);

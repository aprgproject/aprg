...
TEST(KnightsTourTest, GetAnOpenKnightsTourWorksOn3By3) {
    ...
    ChessBoardIndexes const expectedKnightsTour{0, 5, 6, 1, 8, 3, 2, 7};
...
TEST(KnightsTourTest, GetAnOpenKnightsTourWorksOn5By5) {
    ...
    ChessBoardIndexes const expectedKnightsTour{0, 7, 4,  13, 24, 17, 20, 11, 2,  5,  16, 23, 14,
...
TEST(KnightsTourTest, GetAnOpenKnightsTourWorksOn4By5) {
    KnightsTour const knightsTour(4, 5);

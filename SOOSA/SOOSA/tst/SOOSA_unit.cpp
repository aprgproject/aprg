...
TEST(SoosaTest, DISABLED_InvalidBitmapWorks) {
    ...
    inputFile.copyToNewFile(tempFileToTest.getPath());
    SoosaConfiguration soosaConfiguration(getSoosaConfiguration());
    InputConfiguration inputConfiguration(getInputConfigurationForCharityPayWards(tempFileToTest.getPath()));
...
TEST(SoosaTest, DISABLED_Example1Q20DEM11Works) {
    ...
    inputFile.copyToNewFile(tempFileToTest.getPath());
    SoosaConfiguration soosaConfiguration(getSoosaConfiguration());
    InputConfiguration inputConfiguration(getInputConfigurationForDemObas(tempFileToTest.getPath()));
    SOOSA soosa(soosaConfiguration, inputConfiguration);
...
TEST(SoosaTest, DISABLED_ExamplePS2Q21SPECVSWorks) {
    ...
    inputFile.copyToNewFile(tempFileToTest.getPath());
    SoosaConfiguration soosaConfiguration(getSoosaConfiguration());
    InputConfiguration inputConfiguration(getInputConfigurationForSpecialUnits(tempFileToTest.getPath()));
    SOOSA soosa(soosaConfiguration, inputConfiguration);
...
TEST(SoosaTest, DISABLED_ProcessWorksWithADirectory) {
    ...
    SoosaConfiguration soosaConfiguration(getSoosaConfiguration());
    InputConfiguration inputConfiguration(getInputConfigurationForDemObas(inputFile.getPath()));
    SOOSA soosa(soosaConfiguration, inputConfiguration);

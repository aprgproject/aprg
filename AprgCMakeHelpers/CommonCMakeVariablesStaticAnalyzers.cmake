...
if(APRG_ENABLE_STATIC_ANALYZERS)
	...
	if(CPPCHECK_PROGRAM)
		set(CMAKE_C_CPPCHECK ${CPPCHECK_PROGRAM} --enable=all --inline-suppr --suppressions-list=${APRG_DIR}/cppcheck-suppressions.txt)
		set(CMAKE_CXX_CPPCHECK ${CPPCHECK_PROGRAM} --enable=all --inline-suppr --suppressions-list=${APRG_DIR}/cppcheck-suppressions.txt)

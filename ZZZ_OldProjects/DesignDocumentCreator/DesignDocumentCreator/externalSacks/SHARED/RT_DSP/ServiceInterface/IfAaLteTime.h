...
#ifndef _RT_DSP_IFAALTETIME_H
#define _RT_DSP_IFAALTETIME_H
...
/**
* @addtogroup dgUpCcsAaLteTime AaLteTime API
* @{
*/

/**
* @addtogroup dgUpCcsRtDspAaLteTime LteTime API for RT and OSECK DSP nodes
* @{
*/
...
*   @param[in]  hyperFrame          A specific hyper frame value to be waited.
*   @param[in]  frame               A specific frame value to be waited.
*   @param[in]  slot                A specific slot value to be waited.
*   @param[in]  basicTU             A specific chip value to be waited.
...
*   free it, when needed.
*
*   DAALTETIME_VALID_NEXT_HYPERFRAME can be used as hyperFrame
*   parameter. When used, hyperFrame is treated as don't care and
...
*
*   Note that in CCS-RT (Event Machine and RT environment):
...
/** @} */   /* dgUpCcsRtDspAaLteTime */
/** @} */   /* dgUpCcsAaLteTime */
/** @} */   /* dgUpCcs */

#endif /* _RT_DSP_IFAALTETIME_H */

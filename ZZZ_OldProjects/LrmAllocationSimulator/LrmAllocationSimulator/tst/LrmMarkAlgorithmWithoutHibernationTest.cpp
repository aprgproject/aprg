...
TEST(LrmMarkAlgorithmWithoutHibernationTest, McdAllocationWorksWithMasterTcomIsPrioritizedForNyquist) {
    ...
    SelectionDspResult const selectionResult(lrm.allocateMcdForLcgIdAccordingToMark(1));
...
TEST(LrmMarkAlgorithmWithoutHibernationTest, CcdMcdAllocationWorksWithMasterTcomIsPrioritizedForNyquist) {
    ...
    SelectionDspResultForCcdAndMcd const selectionResult(lrm.allocateCcdMcdForLcgIdAccordingToMark(1));
...
TEST(LrmMarkAlgorithmWithoutHibernationTest, DISABLED_FourLcgTwoFspFourCcdNbicMcdPic) {
    HardwareConfiguration hardwareConfiguration;
    Lrm lrm(hardwareConfiguration);
...
TEST(LrmMarkAlgorithmWithoutHibernationTest, DISABLED_FourLcgThreeFspFourCcdMcdPic) {
    HardwareConfiguration hardwareConfiguration;
    Lrm lrm(hardwareConfiguration);
...
TEST(LrmMarkAlgorithmWithoutHibernationTest, DISABLED_TwoLcgFiveFspTwoCcdNbicMcdPic) {
    HardwareConfiguration hardwareConfiguration;
    Lrm lrm(hardwareConfiguration);

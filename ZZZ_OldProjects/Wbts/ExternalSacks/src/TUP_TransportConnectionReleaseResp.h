/**
*******************************************************************************
* @file                  $HeadURL: https://wrscmi.inside.nsn.com/isource/svnroot/BTS_I_WN/tags/WBTS00_ENV_1910_001_00/I_Interface/Application_Env/Wn_Env/Bs_Env/Messages/TUP_TransportConnectionReleaseResp.h $
...
#ifndef _TUP_TRANSPORT_CONNECTION_RELEASE_RESP_H
#define _TUP_TRANSPORT_CONNECTION_RELEASE_RESP_H
...
struct TUP_TransportConnectionReleaseResp
{
...
typedef struct TUP_TransportConnectionReleaseResp TUP_TransportConnectionReleaseResp;

#endif /* _TUP_TRANSPORT_CONNECTION_RELEASE_RESP_H */

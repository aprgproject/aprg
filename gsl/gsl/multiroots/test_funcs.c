...
powellscal_df (const gsl_vector * x, void *params, gsl_matrix * df)
{
  ...
  double df00 = 10000.0 * x1;
  double df01 = 10000.0 * x0;
  double df10 = -exp (-x0);
  double df11 = -exp (-x1);
...
powellsing_df (const gsl_vector * x, void *params, gsl_matrix * df)
{
  ...
  double df10 = 0;
  double df11 = 0;
  double df12 = sqrt (5.0);
  double df13 = -df12;
  double df20 = 0;
  double df21 = 2 * (x1 - 2 * x2);
  double df22 = -2 * df21;
  double df23 = 0;
  double df30 = 2 * sqrt (10.0) * (x0 - x3);
  double df31 = 0;
  double df32 = 0;
  double df33 = -df30;
...
wood_df (const gsl_vector * x, void *params, gsl_matrix * df)
{
  ...
  double df00 = -200.0 * t1 + 1;
  double df01 = -200.0 * x0;
  double df02 = 0;
  double df03 = 0;
  double df10 = -400.0*x0;
  double df11 = 200.0 + 20.2;
  double df12 = 0;
  double df13 = 19.8;
  double df20 = 0;
  double df21 = 0;
  double df22 = -180.0 * t2 + 1;
  double df23 = -180.0 * x2;
  double df30 = 0;
  double df31 = 19.8;
  double df32 = -2 * 180 * x2;
  double df33 = 180.0 + 20.2;
...
helical_df (const gsl_vector * x, void *params, gsl_matrix * df)
{
  ...
  double df00 = 100*x1/t1;
  double df01 = -100.0 * x0/t1;
  double df02 = 10.0;
  double df10 = 10*x0/t2;
  double df11 = 10*x1/t2;
  double df12 = 0;
  double df20 = 0;
  double df21 = 0;
  double df22 = 1.0;

...
public:
    ...
    BaseConnectedComponentsWithVertexToComponentIdMap(BaseConnectedComponentsWithVertexToComponentIdMap&&) noexcept =
        default;
    ...
    BaseConnectedComponentsWithVertexToComponentIdMap& operator=(
        BaseConnectedComponentsWithVertexToComponentIdMap&&) noexcept = default;

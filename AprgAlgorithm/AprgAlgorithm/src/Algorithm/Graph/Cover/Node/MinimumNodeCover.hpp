...
public:
    ...
    [[nodiscard]] int getMinimumNodeCoverSize(Vertex const& newSourceVertex, Vertex const& newSinkVertex) const {
    ...
    [[nodiscard]] int getMaximumIndependentSetSize(Vertex const& newSourceVertex, Vertex const& newSinkVertex) const {
